                    ...
                    <table class="table table-striped table-auto w-full bg-gray-50">
                        <thead class="border-b">
                            <tr class="bg-gray-100">
                                ...
                                <th scope="col" class="p-4 text-center ">RESPONSABLE</th>
                        ...
                        <tbody>
                            @foreach ($pacientes as $paciente)
                                <tr class="border-b hover:bg-gray-50">
                                    {{-- $loop->iteration --}}
                                    <td class="py-4 text-center">{{ $paciente->id }}</td>
                                    ...
                                    <td class="py-4 text-center"> {{ $paciente->responsable }} </td>
                                    ...
                                    <td class="text-right">
                                        <div class="d-flex flex-row bd-highlight mb-3 "
                                            ...
                                            <div class="p-2 text-right bd-highlight">
                                                ...
                                                <a href="{{ route('pacientes.edit', $paciente->id) }}" class="btn-sm btn text-right btn-primary">
                                                    <i class="fas fa-edit"></i>
                                                </a> 
                                            </div>

                                            <div class="p-2 text-right bd-highlight">
                                                <a href=" {{ route('pacientes.show', $paciente->id) }}" class="btn-sm btn text-right btn-warning">
